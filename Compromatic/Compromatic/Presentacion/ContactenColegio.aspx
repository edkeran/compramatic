...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <h1 style="text-align: center;" id="title" runat="server">Contactar Al Mejor Colegio Del Estado<br /><small>Aliados Patrocinadores</small></h1>
    <!--Div Para El Formulario De Contactenos De Colegio-->
    <div style="padding:0px 10%; padding-bottom:4%">
        <div class="form-group">
             <div class="input-group-prepend">
                <span class="input-group-text" runat="server" id="name">Nombre:</span>
             </div>
        ...
        <div class="form-group">
             <div class="input-group-prepend">
                <span class="input-group-text" runat="server" id="lastName">Apellidos:</span>
             </div>
        ...
        <div class="form-group">
            <div class="input-group-prepend">
                <span class="input-group-text" runat="server" id="email">Correo:</span>
            </div>
        ...
        <div class="form-group">
            <div class="input-group-prepend">
                <span class="input-group-text" runat="server" id="phone">Telefono:</span>
            </div>
        ...
        <div class="form-group">
            <div class="input-group-prepend">
                <span class="input-group-text" id="msg" runat="server">Mensaje:</span>
            </div>

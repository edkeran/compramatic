<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/MasterSuperAdministrador.master" AutoEventWireup="true" CodeFile="~/LogicaPresentacion/Administrador/QuejasAdministrador.aspx.cs" Inherits="Presentacion_QuejasAdministrador" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="content" class="content">
        ...
        <h1 class="page-header">PQR <small>nuestro compromiso es contigo</small></h1>
        <div class="row">
            <div class="col-md-10 ui-sortable">
                <ul class="nav nav-tabs nav-tabs-inverse nav-justified nav-justified-mobile" data-sortable-id="index-2">
                    <li class="active"><a href="#latest-post" data-toggle="tab"><i class="fa fa-envelope m-r-5"></i><span class="hidden-xs">PQR Administrador</span></a></li>
                    <li class=""><a href="#purchase" data-toggle="tab"><i class="fa fa-envelope m-r-5"></i><span class="hidden-xs">PQR Empresa</span></a></li>
                    <li class=""><a href="#email" data-toggle="tab"><i class="fa fa-envelope m-r-5"></i><span class="hidden-xs">PQR Cliente</span></a></li>
                </ul>
                <div class="tab-content" data-sortable-id="index-3">
                    <div class="tab-pane fade active in" id="latest-post">
                        <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" BorderStyle="None" AutoGenerateColumns="False">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>

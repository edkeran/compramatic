<%@ page title="" language="C#" masterpagefile="~/Presentacion/MasterSuperAdministrador.master" autoeventwireup="true" inherits="Presentacion_MostrarTablaEmpresa, App_Web_4kwpqrqr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active" id="all" runat="server">Ver todas</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header" id="usr_emp" runat="server">Usuarios - Empresas <small id="our_com" runat="server"> nuestro compromiso es contigo</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12" >
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title" id="empres" runat="server">Empresas</h4>
                        </div>
                        <div class="alert alert-success fade in">
                            <button type="button" class="close" data-dismiss="alert">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            <asp:Label ID="LB_Emp_Reg" runat="server" Text="Estas son las empresas registrados actualmente."></asp:Label>
                             <br />
                        ...
                        <div class="panel-body">
                            ...
                            <asp:GridView ID="GridView1" runat="server" class="table table-striped table-bordered nowrap data-table" DataSourceID="ObjectDataSource1" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="nomEmpresa,calificacionEmpresa,nitEmpresa" Width="100%">
                               ...
                               <RowStyle CssClass="sorting_1" />
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="MostrarEmpresas" TypeName="Logica.L_Componentes">
                                    <SelectParameters>

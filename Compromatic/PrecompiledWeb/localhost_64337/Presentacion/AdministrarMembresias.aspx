<%@ page title="" language="C#" masterpagefile="~/Presentacion/MasterSuperAdministrador.master" autoeventwireup="true" inherits="Presentacion_AdministrarMembresias, App_Web_4kwpqrqr" %>
                        ...
                        <div class="panel panel-inverse">
                            ...
                            <div class="panel-body">
                                <asp:Panel ID="Panel2" runat="server">
                                    ...
                                    <asp:ObjectDataSource runat="server" ID="ObjectDataSource1" SelectMethod="Membresia" TypeName="Logica.L_Componentes"></asp:ObjectDataSource>
                                </asp:Panel>
                            </div>
                        </div>
                    </div>
